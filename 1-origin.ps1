...
if (!$taskPathExist) {
    ...
    # Implementation:
    # - Adapted from [ntdll]::NtQuerySystemInformation's implementation
    # - https://stackoverflow.com/questions/1606140/how-can-a-program-delete-its-own-executable/1606189#1606189
    # - https://www.catch22.net/tuts/system/self-deleting-executables/#the-movefileex-method
